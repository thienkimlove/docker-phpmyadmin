...
# ADD . /srv/www
RUN ln -s /usr/share/phpmyadmin /srv/www
RUN cp /srv/www/config.sample.inc.php /srv/www/config.inc.php
RUN sed -e 's/tcp/socket/' -i /srv/www/config.inc.php
RUN sed -e 's/mysqli/mysql/' -i /srv/www/config.inc.php
